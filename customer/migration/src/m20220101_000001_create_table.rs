    ...
    async fn up(&self, manager: &SchemaManager) -> Result<(), DbErr> {
        ...
        manager.create_table(
            Table::create()
                ...
                .col(ColumnDef::new(User::UserId).string_len(36).not_null().comment("用户ID"))
        ...
        manager.create_table(
            Table::create()
                ...
                .col(ColumnDef::new(UserRole::UserId).string_len(36).not_null().comment("用户ID"))
                .col(ColumnDef::new(UserRole::RoleId).integer().not_null().comment("角色ID"))
                .col(
                    ColumnDef::new(UserRole::CreateBy).string_len(36).not_null().comment("创建人ID")
                )
                .col(
                    ColumnDef::new(UserRole::UpdateBy).string_len(36).not_null().comment("更新人ID")
                )
                .col(
