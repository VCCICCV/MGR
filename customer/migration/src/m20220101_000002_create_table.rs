    ...
    async fn up(&self, manager: &SchemaManager) -> Result<(), DbErr> {
        ...
        manager.create_table(
            Table::create()
                ...
                .col(ColumnDef::new(OrderItem::OrderId).string_len(36).not_null().comment("订单 ID"))
                .col(ColumnDef::new(OrderItem::UserId).string_len(36).not_null().comment("用户 ID"))

                .col(ColumnDef::new(OrderItem::OrderSn).string_len(36).not_null().comment("订单编号"))
                .col(
