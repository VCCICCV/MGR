    ...
    async fn up(&self, manager: &SchemaManager) -> Result<(), DbErr> {
        ...
        manager.create_table(
            Table::create()
                ...
                .col(ColumnDef::new(User::UserId).big_integer().not_null().auto_increment())
        ...
        manager.create_table(
            Table::create()
                ...
                .col(
                    ColumnDef::new(UserRole::CreateBy).big_integer().not_null().comment("创建人ID")
                )
                .col(
                    ColumnDef::new(UserRole::UpdateBy).big_integer().not_null().comment("更新人ID")
                )
                .col(
