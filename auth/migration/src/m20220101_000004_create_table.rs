    ...
    async fn up(&self, manager: &SchemaManager) -> Result<(), DbErr> {
        ...
        manager.create_table(
            Table::create()
                ...
                .col(ColumnDef::new(ProductAttribute::CreateTime).date_time().comment("创建时间"))
                .col(ColumnDef::new(ProductAttribute::UpdateTime).date_time().comment("修改时间"))
                .col(
        ...
        manager.create_table(
            Table::create()
                ...
                .col(ColumnDef::new(ProductBrand::CreateTime).date_time().comment("创建时间"))
                .col(ColumnDef::new(ProductBrand::UpdateTime).date_time().comment("修改时间"))
                .col(
        ...
        manager.create_table(
            Table::create()
                ...
                .col(ColumnDef::new(ProductCategory::CreateTime).date_time().comment("创建时间"))
                .col(ColumnDef::new(ProductCategory::UpdateTime).date_time().comment("修改时间"))
                .col(
        ...
        // 创建 product_sku_0 到 product_sku_15 表
        ...
        manager.create_table(
            Table::create()
                ...
                .col(ColumnDef::new(ProductComment::ProductId).big_integer().comment("商品 ID"))
                .col(
                    ColumnDef::new(ProductComment::ProductSkuId)
                        .big_integer()
                        .comment("商品 SKU ID")
                )
                .col(ColumnDef::new(ProductComment::UserId).big_integer().comment("用户 ID"))
                .col(
                ...
                .col(ColumnDef::new(ProductComment::CreateTime).date_time().comment("创建时间"))
                .col(ColumnDef::new(ProductComment::UpdateTime).date_time().comment("修改时间"))
                .col(
        ...
        manager.create_table(
            Table::create()
                ...
                .col(ColumnDef::new(ProductSku::BrandId).big_integer().comment("商品品牌 ID"))
                .col(ColumnDef::new(ProductSku::ProductId).big_integer().comment("商品 ID"))
                ...
                .col(ColumnDef::new(ProductSku::CreateTime).date_time().comment("创建时间"))
                .col(ColumnDef::new(ProductSku::UpdateTime).date_time().comment("修改时间"))
                .col(
        ...
        manager.create_table(
            Table::create()
                ...
                .col(ColumnDef::new(ProductSpu::CategoryId).big_integer().comment("商品类型 ID"))
                .col(ColumnDef::new(ProductSpu::BrandId).big_integer().comment("商品品牌 ID"))
                ...
                .col(
                    ColumnDef::new(ProductSpu::PromotionEndTime).date_time().comment("促销结束时间")
                )
                ...
                .col(ColumnDef::new(ProductSpu::CreateTime).date_time().comment("创建时间"))
                .col(ColumnDef::new(ProductSpu::UpdateTime).date_time().comment("修改时间"))
                .col(
...
// 产品评论枚举（以 product_comment_0 为例，其他同理）
#[derive(DeriveIden)]
enum ProductComment {
    Table,
    Id,
...
// 产品库存枚举（以 product_sku_0 为例，其他同理）
#[derive(DeriveIden)]
enum ProductSku {
    Table,
    Id,
