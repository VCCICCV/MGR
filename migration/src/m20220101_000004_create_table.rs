    ...
    async fn up(&self, manager: &SchemaManager) -> Result<(), DbErr> {
        ...
        manager.create_table(
            Table::create()
                ...
                .col(ColumnDef::new(ProductSku::BrandId).string_len(36).not_null().comment("商品品牌 ID"))
                .col(ColumnDef::new(ProductSku::ProductId).string_len(36).not_null().comment("商品 ID"))
        ...
        manager.create_table(
            Table::create()
                ...
                .col(ColumnDef::new(ProductSpu::CategoryId).big_integer().not_null().comment("商品类型 ID"))
                .col(ColumnDef::new(ProductSpu::BrandId).string_len(36).not_null().comment("商品品牌 ID"))
